...
<div class="mb-4">
    <label for="ppat" class="block text-sm font-medium text-gray-700">PPAT</label>
    <select id="ppat" name="ppat" class="border-gray-300 border rounded-lg p-2 w-full bg-gray-100">
...
<div class="mb-4">
    ...
    <select id="jenis_transaksi" name="jenis_transaksi" class="border-gray-300 border rounded-lg p-2 w-full bg-gray-100">
        <option value="">Pilih</option>
        <option value="Jalan">Jalan</option>
        <option value="Gang">Gang</option>
        <option value="Komplek">Komplek</option>
...
<div class="mb-4">
    <label for="jenis_kepemilikan" class="block text-sm font-medium text-gray-700">Jenis Kepemilikan</label>
    <select id="jenis_kepemilikan" name="jenis_kepemilikan" class="border-gray-300 border rounded-lg p-2 w-full bg-gray-100">
        <option value="">Pilih</option>
        <option value="Jalan">Jalan</option>
        <option value="Gang">Gang</option>
        <option value="Komplek">Komplek</option>
        <option value="Perumahan">Perumahan</option>
             ...
             <div class="mb-4">
                ...
                <input type="text" id="luas_bumi_transaksi" name="luas_bumi_transaksi" class="border-gray-300 border rounded-lg p-2 w-full">
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="mb-4">
