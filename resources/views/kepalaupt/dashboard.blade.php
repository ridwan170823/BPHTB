...
@section('content')
    ...
    <p>Selamat datang, {{ auth()->user()->name }}!</p>
     <div class="p-6">
        <h1 class="text-2xl font-bold mb-4">Dashboard Kepala UPT</h1>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    @foreach($pengajuans as $pengajuan)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('kepalaupt.show', $pengajuan->no_urut_p) }}" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded">Detail</a>
